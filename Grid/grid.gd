...
# Piece Stuff
var possible_pieces = [
	load("res://Pieces/Angry.tscn"),
	load("res://Pieces/Blushy.tscn"),
	load("res://Pieces/Cocky.tscn"),
	load("res://Pieces/Dazed.tscn"),
	load("res://Pieces/Dog.tscn"),
	load("res://Pieces/Happy.tscn"),
	load("res://Pieces/Sly.tscn"),
	load("res://Pieces/Face.tscn"),
]
